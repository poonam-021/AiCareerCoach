    ...
    <div className="relative hidden w-1/2 flex-col justify-between overflow-hidden bg-[#0F2E2B] p-10 text-white lg:flex">
      ...
      <div>
        <h2 className="font-serif text-[34px] leading-[1.15] text-white">
          Your career,<br />mapped step by step.
        </h2>
    ...
    <div className="flex min-h-screen bg-white">
      ...
      <div className="flex w-full flex-col justify-center px-8 lg:w-1/2 lg:px-16">
        <div className="mx-auto w-full max-w-sm">
          <h1 className="text-[22px] font-semibold text-ink-900">Welcome back</h1>
          ...
          <p className="mt-6 text-center text-[13px] text-ink-500">
            ...
            <Link to="/signup" className="font-semibold text-[#0F2E2B]">Sign up</Link>
          </p>
        </div>
      </div>
    </div>
